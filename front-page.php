...
if( $link ): ?>
    <a class="btn btn-primary btn-lg btn-block " href="<?php echo esc_url( $link ); ?>">Ofsted report</a>
<?php endif; ?>
...
<div>
    ...
    if( $link ): ?>
        <a class="btn btn-primary btn-lg btn-block" href="<?php echo esc_url( $link ); ?>">Charity information</a>
    <?php endif; ?>
</div>
